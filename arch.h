...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 16, 0)
#define PRCTL_SYMBOL "__arm_sys_prctl"
#define SYS_READ_SYMBOL "__arm_sys_read"
#define SYS_NEWFSTATAT_SYMBOL "__arm_sys_newfstatat"
#define SYS_FACCESSAT_SYMBOL "__arm_sys_faccessat"
#define SYS_EXECVE_SYMBOL "__arm_sys_execve"
#else
#define PRCTL_SYMBOL "sys_prctl"
#define SYS_READ_SYMBOL "sys_read"
#define SYS_NEWFSTATAT_SYMBOL "sys_newfstatat"
